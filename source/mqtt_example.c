...
int main(int argc, char *argv[])
{
    ...
    while (1) {
        /* By default, device doesn't have 'Publish' privilege for topic '/<ProductKey>/<DeviceName>/user/get'.
         * To avoid annoying 'Publish' message, remove it. For test, publish to this topic from Alibaba Cloud
