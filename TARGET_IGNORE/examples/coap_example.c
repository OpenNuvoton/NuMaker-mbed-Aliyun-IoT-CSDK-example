...
int main(int argc, char **argv)
{
...
#if !defined(_WIN32) && !defined(BUILD_AOS) && !defined(__MBED__)
    ...
    /* Move out of the scope below to avoid memory corruption */
    char url[256] = {0};
    ...
    if (0 == strncmp(env, "pre", strlen("pre"))) {
        ...
        if (0 == strncmp(secur, "psk", strlen("psk"))) {
            /* Memory corruption here after exit this scope. Move outside. */
            //char url[256] = {0};
